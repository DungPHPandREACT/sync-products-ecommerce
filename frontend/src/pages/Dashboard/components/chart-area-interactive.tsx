...
export const description = "Biểu đồ area tương tác";
        ...
        <CardAction>
          ...
          <Select value={timeRange} onValueChange={setTimeRange}>
            ...
            <SelectContent className="rounded-xl">
              <SelectItem value="90d" className="rounded-lg">3 tháng</SelectItem>
              <SelectItem value="30d" className="rounded-lg">30 ngày</SelectItem>
              <SelectItem value="7d" className="rounded-lg">7 ngày</SelectItem>
            </SelectContent>
          </Select>
        </CardAction>
      </CardHeader>
